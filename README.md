...
● A Laptop or a Computer with a USB-A Port (USB 3.0 works better but if your Laptop or Computer doesn't have it. Then what Computer is it? BTW no offense intended for MacBooks hehe just get a type c hub idk.)
